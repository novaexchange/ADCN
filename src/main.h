...
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/8;         // 500KB  block soft limit
...
static const int64 MAX_MONEY = 2100000000 * COIN; // AsiaDigiCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 3) / 250; // AsiaDigiCoin: Priority cutoff is 2 AsiaDigiCoin day / 250 bytes.
    }
