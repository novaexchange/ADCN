...
uint256 hashGenesisBlock("0x3646befd2d3d33d648545cec8c6855fcbdc44d0e19b7c758d3fa4ccb68316008");
...
{
    // AsiaDigiCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "AsiaDigiCoin Genesis";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	    ...
	    assert(block.hashMerkleRoot == uint256("0x178162bd4f86042af44e110dc2cbc26a210c60cb497ee408ee9368bca4c089a8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd4, 0xce, 0x9f, 0xab };
